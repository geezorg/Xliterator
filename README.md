...
for writing conventions around the world. A text window allows for the conversion of text samples, another window allows you to load Microsoft
...
editor allows you to set syntax coloring any way you desire.
...
made with the  **Script In** and **Script Out** menus. External transliteration files may be loaded in the usual way via **File &gt; Open ICU File...** .  
...
When an internal transliteration is loaded into the editor, the *Direction* menu is automatically set.  When an external file is loaded, the *Direction* menu
...
Java is installed on your Windows system, you likely need to fix the Windows registry.  Try downloading and launching
